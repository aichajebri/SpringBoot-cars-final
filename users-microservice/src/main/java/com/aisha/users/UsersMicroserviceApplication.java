...
import com.aisha.users.service.UserService;
...
public class UsersMicroserviceApplication {
	 ...
	 * User(null,"aisha","123",true,null)); userService.saveUser(new
	 * User(null,"lovegood","123",true,null));
	 * 
	 * //ajouter les rôles aux users userService.addRoleToUser("admin", "ADMIN");
	 * userService.addRoleToUser("admin", "USER");
	 * 
	 * userService.addRoleToUser("aisha", "USER");
	 * userService.addRoleToUser("lovegood", "USER"); }
	 */
